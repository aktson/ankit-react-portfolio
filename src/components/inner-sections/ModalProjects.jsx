		...
		<div className="p-2 md:flex justify-center items-center" id="my-modal">
			<AnimatePresence>
				<motion.div
					...
					<div className="max-w-2xl bg-base-100 rounded-lg grid  grid-rows-auto md:grid-rows-2 ">
						...
						<div className="card-body bg-base-100">
							...
							<p className="text-neutral  text-left mb-5 line-break overflow-y-auto">{summary}</p>
